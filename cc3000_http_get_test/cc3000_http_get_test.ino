...
// What page to grab!
#define WEBSITE      "www.bitmenu.com"
#define WEBPAGE      "/nginx.html"
...
void sendGet(String query) {
  ...
  if (www.connected()) {
    ...
    www.fastrprint(F("\r\n"));
    www.fastrprint(F("User-Agent: Arduino-Uno-cc3000\r\n"));
    www.fastrprint(F("\r\n"));
    www.println();
  } 
  else {
